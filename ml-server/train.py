...
# Note: The Torch version in the Pipfile won't run this on the GPU. 
# It'd be best to ignore pipenv and install separate PyTorch with GPU support on your own system.

# Alternatively, install it using: pipenv install --index "https://download.pytorch.org/whl/cu117/" "torch==2.0.1"
